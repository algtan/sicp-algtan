...
function mockContext(chapter = 1, variant = 'default') {
    return createContext_1.default(chapter, variant);
}
exports.mockContext = mockContext;
function mockRuntimeContext() {
    const context = createContext_1.default();
    context.runtime = {
        break: false,
        debuggerOn: true,
        isRunning: true,
...
function mockEnvironment(context, name = 'blockEnvironment', head = {}) {
    return interpreter_1.createBlockEnvironment(context, name, head);
}
