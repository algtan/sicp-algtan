...
test('Cannot leave blank init in for loop', () => {
  ...
  `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing init expression in for statement."`);
});
...
test('Cannot leave blank test in for loop', () => {
  ...
  `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing test expression in for statement."`);
});
...
test('Cannot leave blank update in for loop', () => {
  ...
  `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing update expression in for statement."`);
});
...
test('Cannot leave blank expressions in for loop', () => {
  ...
  `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing init, test, update expressions in for statement."`);
});
...
test('Cannot leave while loop predicate blank', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: SyntaxError: Unexpected token (1:7)"`);
});
...
test('Cannot use update expressions', () => {
    ...
    x++;
    x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Update expressions are not allowed"`);
});
...
test('Cannot have incomplete statements', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    5
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing semicolon at the end of statement"`);
});
...
test('Cannot have if without else in chapter <= 2', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    if (true) { 5; }
    `, { chapter: 2 }).toMatchInlineSnapshot(`"Line 1: Missing \\"else\\" in \\"if-else\\" statement."`);
});
test('Cannot have if without else in chapter <= 2 - verbose', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    "enable verbose";
    if (true) { 5; }
    `, { chapter: 2 }).toMatchInlineSnapshot(`
...
test('Cannot use multiple declarations', () => {
    ...
    let x = 3, y = 5;
    x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Multiple declaration in a single statement."`);
});
...
test('Cannot use destructuring declarations', () => {
    ...
    let [a, b] = x;
    a;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Array patterns are not allowed"`);
});
...
test('no declaration without assignment', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    let x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing value in variable declaration."`);
});
...
test('no var statements', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    var x = 1;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Variable declaration using \\"var\\" is not allowed."`);
});
...
test('Cannot use update statements', () => {
    ...
    x += 5;
    x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: The assignment operator += is not allowed. Use = instead."`);
});
...
test('for needs braces', () => {
    ...
    for (let i = 0; i < 1; i = i + 1)
      i;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Missing curly braces around \\"for\\" block."`);
});
...
test('while needs braces', () => {
    ...
    while (i < 1)
      i = i + 1;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Missing curly braces around \\"while\\" block."`);
});
...
test('No empty statements', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    ;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Empty statements are not allowed"`);
});
...
test('No array expressions in chapter 2', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    [];
    `, { chapter: 2 }).toMatchInlineSnapshot(`"Line 1: Array expressions are not allowed"`);
});
...
test('No spread in array expressions', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    [...[]];
    `, { chapter: 3 }).toMatchInlineSnapshot(`"Line 1: Spread syntax is not allowed in arrays."`);
});
test('No trailing commas in arrays', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    [1,];
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Trailing comma"`);
});
...
test('No trailing commas in objects', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 3: Trailing comma"`);
});
...
test('no generator functions', () => {
  ...
  `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Yield expressions are not allowed"`);
});
...
test('no export function', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Export named declarations are not allowed"`);
});
...
test('no export default', () => {
    ...
    const x = 1;
    export default x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Export default declarations are not allowed"`);
});
...
test('no sequence expression', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    (1, 2);
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Sequence expressions are not allowed"`);
});
...
test('no interface', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: SyntaxError: The keyword 'interface' is reserved (1:0)"`);
});
...
test('no this, no new', () => {
    ...
    const box = new Box();
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Expected string as prop, got number."`);
});
...
test('no unspecified operators', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    1 << 10;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: Operator '<<' is not allowed."`);
});
...
test('no unspecified unary operators', () => {
    ...
    let x = 5;
    typeof x;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Operator 'typeof' is not allowed."`);
});
...
test('no implicit undefined return', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 2: Missing value in return statement."`);
});
...
test('no repeated params', () => {
    ...
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: SyntaxError: Argument name clash (1:14)"`);
});
...
test('no declaring reserved keywords', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    let yield = 5;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: SyntaxError: The keyword 'yield' is reserved (1:4)"`);
});
...
test('no assigning to reserved keywords', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    package = 5;
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: SyntaxError: The keyword 'package' is reserved (1:0)"`);
});
...
test('no holes in arrays', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    [1, , 3];
    `, { chapter: 100 }).toMatchInlineSnapshot(`"Line 1: No holes are allowed in array literals."`);
});
test('no assigning to reserved keywords - verbose', () => {
    return testing_1.expectParsedError(formatters_1.stripIndent `
    "enable verbose";
