...
describe('standard opcodes', () => {
    test('LGCI works', () => {
        return testing_1.expectDisplayResult(`display(123);`, { chapter: 3, variant: 'concurrent' })
    ...
    test('LGCF64 works', () => {
        return testing_1.expectDisplayResult(`display(1.5);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "1.5",
              ]
    ...
    test('LGCB0 works', () => {
        return testing_1.expectDisplayResult(`display(false);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "false",
              ]
    ...
    test('LGCB1 works', () => {
        return testing_1.expectDisplayResult(`display(true);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "true",
              ]
    ...
    test('LGCU works', () => {
        return testing_1.expectDisplayResult(`display(undefined);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "undefined",
              ]
    ...
    test('LGCN works', () => {
        return testing_1.expectDisplayResult(`display(null);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "null",
              ]
    ...
    test('LGCS works', () => {
        return testing_1.expectDisplayResult(`display("test string");`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "\\"test string\\"",
              ]
    ...
    test('ADDG works for numbers', () => {
        return testing_1.expectDisplayResult('display(-1+1);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "0",
              ]
    ...
    test('ADDG works for strings', () => {
        return testing_1.expectDisplayResult('display("first"+"second");', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "\\"firstsecond\\"",
              ]
    ...
    test('ADDG fails for ill-typed operands', () => {
        return testing_1.expectParsedError('1+undefined;', {
            chapter: 3,
            variant: 'concurrent'
    ...
    test('SUBG works for numbers', () => {
        return testing_1.expectDisplayResult('display(123-124);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "-1",
              ]
    ...
    test('MULG works for numbers', () => {
        return testing_1.expectDisplayResult('display(123*2);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "246",
              ]
    ...
    test('DIVG works for numbers', () => {
        return testing_1.expectDisplayResult('display(128/32);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "4",
              ]
    ...
    test('DIVG fails for division by 0', () => {
        return testing_1.expectParsedError('128/0;', { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: execution aborted: division by 0"`);
    });
    ...
    test('MODG works for numbers', () => {
        return testing_1.expectDisplayResult('display(128%31);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "4",
              ]
    ...
    test('NEGG works', () => {
        return testing_1.expectDisplayResult('display(-1);display(-(-1));', {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('NEGG fails for ill-typed operands', () => {
        return testing_1.expectParsedError('-"hi";', {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`"Error: execution aborted: Expected number, got string for -."`);
    });
    test('NOTG works', () => {
        return testing_1.expectDisplayResult('display(!false);display(!true);', {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LTG works for strings', () => {
        return testing_1.expectDisplayResult('display("abc" < "bcd"); display("bcd" < "abc");', {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LEG works for numbers', () => {
        return testing_1.expectDisplayResult(formatters_1.stripIndent `
        display(5 <= 10);
        display(5 <= 5);
        display(10 <= 5);
        `, {
    ...
    test('function and function calls work', () => {
        ...
        display(f(3));
        display(f);
        `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`
              Array [
                "3",
                "1",
                "\\"<Function>\\"",
    ...
    test('STLG and LDLG works', () => {
        return testing_1.expectDisplayResult(`const x = 1; display(x);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "1",
              ]
    ...
    test('array opcodes work', () => {
        return testing_1.expectDisplayResult(`const x = [1,2,3,1]; display(x[1]); display(x[8]);`, {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LDAG fails for non-array', () => {
        return testing_1.expectParsedError('1[0];', {
            chapter: 3,
            variant: 'concurrent'
...
describe('primitive opcodes', () => {
    describe('self-implemented', () => {
        ...
        test('ARRAY_LEN fails for ill-typed argument', () => {
            return testing_1.expectParsedError('array_length(1);', {
                chapter: 3,
                variant: 'concurrent'
            }).toMatchInlineSnapshot(`"Error: execution aborted: Expected array, got number for array_length."`);
        });
        test('DRAW_DATA works', () => {
            return testing_1.expectVisualiseListResult(formatters_1.stripIndent `
        ...
        test('ERROR works', () => {
            return testing_1.expectParsedError('error(123);', {
                chapter: 3,
                variant: 'concurrent'
        ...
        test('ARITY fails for ill-typed argument', () => {
            return testing_1.expectParsedError('arity(1);', {
                chapter: 3,
                variant: 'concurrent'
        ...
        test('stream_tail fails for ill-typed arguments', () => {
            return testing_1.expectParsedError(formatters_1.stripIndent `
        stream_tail(1);
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: \\"stream_tail(xs) expects a pair as argument xs, but encountered 1\\""`);
        });
    });
    test('nullary handler', () => {
        return testing_1.snapshotSuccess('get_time();', { chapter: 3, variant: 'concurrent' });
    });
    test('unary handler', () => {
        return testing_1.expectDisplayResult(formatters_1.stripIndent `
          display(math_abs(-1));
    ...
    describe('concurrent', () => {
        ...
        test('TEST_AND_SET fails for ill-typed arguments', () => {
            return testing_1.expectParsedError(formatters_1.stripIndent `
        test_and_set(1);
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: execution aborted: Expected array, got number for test_and_set."`);
        });
        test('CLEAR works', () => {
            return testing_1.expectDisplayResult(formatters_1.stripIndent `
          const x = list(true);
        ...
        test('CLEAR fails for ill-typed arguments', () => {
            return testing_1.expectParsedError(formatters_1.stripIndent `
        clear(1);
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: execution aborted: Expected array, got number for clear."`);
        });
    });
});
describe('standard program execution', () => {
    test('program always returns all threads terminated', () => {
        return testing_1.expectResult('1 + 1;', { chapter: 3, variant: 'concurrent' }).toBe('all threads terminated');
    });
    ...
    test('logical operators work', () => {
        return testing_1.expectDisplayResult('display(!(true && (false || (true && !false))));', {
            chapter: 3,
            variant: 'concurrent'
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('&& operator shortcircuit works', () => {
        return testing_1.snapshotSuccess(formatters_1.stripIndent `
        function f() {
          f();
        }
        false && f();
    ...
    test('program times out', () => {
        return testing_1.expectParsedError('while(true) {}', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
    ...
    test('block scoping works, part 2', () => {
        ...
        display(i);
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Line 4: Name i not declared."`);
    });
    test('return in loop throws error', () => {
        return testing_1.expectParsedError(formatters_1.stripIndent `
          ...
          f();
        `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: return not allowed in loops"`);
    });
    ...
    test('const assignment throws error', () => {
        ...
        const x = 1;
        x = 2;
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Line 2: Cannot assign new value to constant x."`);
    });
    ...
    test('wrong number of arguments for internal functions throws error', () => {
        ...
        const x = list(false);
        test_and_set(x, 1);
      `, { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: execution aborted: Expected 1 arguments, but got 2."`);
    });
    test('wrong number of arguments for normal functions throws error', () => {
        return testing_1.expectParsedError('((x, y) => 1)(1);', {
            chapter: 3,
            variant: 'concurrent'
...
test('concurrent program execution interleaves', () => {
    const code = formatters_1.stripIndent `
    const t1 = () => {
  ...
  `;
    return testing_1.getDisplayResult(code, { chapter: 3, variant: 'concurrent' }).then(displayResult => {
...
test('concurrent program execution interleaves (busy wait)', () => {
  ...
  `;
    return testing_1.getDisplayResult(code, { chapter: 3, variant: 'concurrent' });
});
