...
exports.createEmptyContext = (chapter, variant = 'default', externalSymbols, externalContext, moduleParams) => {
    return {
        chapter,
        externalSymbols,
        errors: [],
        ...
        unTypecheckedCode: [],
        typeEnvironment: typeChecker_1.createTypeEnvironment(chapter),
        previousCode: []
    };
};
...
exports.defineSymbol = (context, name, value) => {
    ...
    if (!typeEnv.declKindMap.has(name)) {
        typeEnv.typeMap.set(name, typeChecker_1.tForAll(typeChecker_1.tVar('T1')));
...
const createContext = (chapter = 1, variant = 'default', externalSymbols = [], externalContext, externalBuiltIns = defaultBuiltIns, moduleParams) => {
    if (runner_1.isFullJSChapter(chapter)) {
        // fullJS will include all builtins and preludes of source 4
        return Object.assign(Object.assign({}, createContext(4, variant, externalSymbols, externalContext, externalBuiltIns, moduleParams)), { chapter: -1 });
    }
    const context = exports.createEmptyContext(chapter, variant, externalSymbols, externalContext, moduleParams);
    exports.importBuiltins(context, externalBuiltIns);
