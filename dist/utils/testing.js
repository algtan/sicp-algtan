...
function createTestContext({ context, chapter = 1, variant = 'default', testBuiltins = {} } = {}) {
    if (context !== undefined) {
        ...
        const testContext = Object.assign(Object.assign({}, createContext_1.default(chapter, variant, [], undefined, {
        ...
        Object.entries(testBuiltins).forEach(([key, value]) => createContext_1.defineBuiltin(testContext, key, value));
        return testContext;
    }
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const getTestResult = (context, result) => {
            const testResult = {
                ...
                parsedErrors: index_1.parseError(context.errors),
        ...
        const interpretedResult = getTestResult(interpretedTestContext, yield index_1.runInContext(code, interpretedTestContext, {
            scheduler,
        ...
        if (options.native) {
            ...
            let pretranspiled = '';
            let transpiled = '';
            const parsed = parser_1.parse(code, nativeTestContext);
            if (parsed === undefined) {
                ...
                switch (options.variant) {
                    case 'gpu':
                        gpu_1.transpileToGPU(parsed);
                        pretranspiled = astring_1.generate(parsed);
                        break;
                    case 'lazy':
                        lazy_1.transpileToLazy(parsed);
                        pretranspiled = astring_1.generate(parsed);
                        break;
                }
                try {
                    transpiled = transpiler_1.transpile(parsed, nativeTestContext, true).transpiled;
            ...
            const nativeResult = getTestResult(nativeTestContext, yield index_1.runInContext(code, nativeTestContext, {
                scheduler,
            ...
            for (const property of propertiesThatShouldBeEqual) {
                const nativeValue = stringify_1.stringify(nativeResult[property]);
                const interpretedValue = stringify_1.stringify(interpretedResult[property]);
...
function expectNativeToTimeoutAndError(code, timeout) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const context = context_1.mockContext(4);
        const promise = index_1.runInContext(code, context, {
        ...
        return index_1.parseError(context.errors);
    });
}
