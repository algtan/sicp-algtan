...
function head(xs) {
    if (is_pair(xs)) {
        ...
        throw new Error('head(xs) expects a pair as argument xs, but encountered ' + stringify_1.stringify(xs));
    }
}
exports.head = head;
...
function tail(xs) {
    if (is_pair(xs)) {
        ...
        throw new Error('tail(xs) expects a pair as argument xs, but encountered ' + stringify_1.stringify(xs));
    }
}
exports.tail = tail;
...
function set_head(xs, x) {
    if (is_pair(xs)) {
        ...
        throw new Error('set_head(xs,x) expects a pair as argument xs, but encountered ' + stringify_1.stringify(xs));
    }
}
...
function set_tail(xs, x) {
    if (is_pair(xs)) {
        ...
        throw new Error('set_tail(xs,x) expects a pair as argument xs, but encountered ' + stringify_1.stringify(xs));
    }
}
