...
function toValidatedAst(code) {
    ...
    const ast = parser_1.parse(code, context);
...
test('for loop variable cannot be reassigned', () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    return testing_1.expectParsedError(code, { chapter: 4 }).toMatchInlineSnapshot(`"Line 2: Assignment to a for loop variable in the for loop is not allowed."`);
}));
test('for loop variable cannot be reassigned in closure', () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    return testing_1.expectParsedError(code, { chapter: 4 }).toMatchInlineSnapshot(`"Line 3: Assignment to a for loop variable in the for loop is not allowed."`);
}));
test('testing typability', () => {
  ...
  `;
    ...
    walkers_1.simple(ast, {
        VariableDeclaration(node) {
            let expectedTypability = '';
            switch (astCreator_1.getVariableDecarationName(node)) {
                case 'a':
                case 'b':
