...
function renameVariables(baseNode, namesToRename) {
    ...
    walkers_1.recursive(baseNode, new Set(), {
...
function compileForConcurrent(program, context) {
    ...
    const prelude = compilePreludeToIns(parser_1.parse(vm_prelude_1.vmPrelude, context));
    vm_prelude_1.generatePrimitiveFunctionCode(prelude);
